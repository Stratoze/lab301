...
class PasswordControllerTest {
    ...
    void forgotPassword_ValidEmail_ReturnsGenericSuccess() {
        ...
        ResponseEntity<ApiResponse<String>> response =
                passwordController.forgotPassword(Map.of("email", "khach1@gmail.com"));
    ...
    void forgotPassword_UnknownEmail_StillReturnsSuccess() {
        ...
        ResponseEntity<ApiResponse<String>> response =
                passwordController.forgotPassword(Map.of("email", "unknown@gmail.com"));
    ...
    void resetPassword_ValidToken_ReturnsSuccess() {
        ...
        ResponseEntity<ApiResponse<String>> response =
                passwordController.resetPassword(
                        Map.of("token", "valid-token", "newPassword", "NewStrongPass1!"));
    ...
    void resetPassword_InvalidToken_ServiceThrowsException() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(RuntimeException.class, () ->
                passwordController.resetPassword(
                        Map.of("token", "bad-token", "newPassword", "NewStrongPass1!")));
    }
