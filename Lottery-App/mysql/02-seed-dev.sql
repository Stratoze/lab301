...
-- =================================================================================
-- LOTTERY CHECKER - SEED DATA (DEV ONLY)
-- =================================================================================

USE lottery_db;

-- Password: 'phucpddfx03285' | BCrypt Cost 12
...
-- ===== PASSWORD RESET TOKENS (15 records) =====
...
-- ===== PRIZE DETAILS (18 records) =====
-- NOTE: G_DB for Hà Nội fixed to 6 digits ('012345' instead of '12345')
...
(10, 'G_DB', '012345', 500000000), (10, 'G1', '54321', 10000000),
(4, 'G8', '12', 100000), (4, 'G_DB', '123456', 2000000000);

-- ===== CHECK SESSIONS (15 records) =====
...
-- ===== CHECK HISTORIES (15 records) =====
-- NOTE: Hà Nội ticket fixed to 6 digits ('012345' instead of '12345')
